...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        user = CustomeUser.objects.get(type=UserType.admin.value)
        # List of images
        image_list = [
            "./images/img1.jpg",
            "./images/img2.jpg",
        ...
        for _ in range(150):  # Generate 10 fake products
            user = user  
        ...
        self.stdout.write(self.style.SUCCESS('Successfully generated 150 fake products'))